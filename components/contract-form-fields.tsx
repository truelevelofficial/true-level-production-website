...
export function ContractFormFields({ defaultRep, defaultPaymentTerms, defaultCancellationPolicy, services }: { defaultRep: string; defaultPaymentTerms: string; defaultCancellationPolicy: string; services: readonly string[] }) {
  ...
  const clauseLabels: Record<string, string[]> = {
    CONTENT_CREATORS: [
      ...
      "البند السادس: التزامات الطرف الثاني (صانع المحتوى)",
      "البند السابع: الحضور والغياب والانضباط",
      "البند الثامن: المقابل المالي وآلية احتساب الأرباح",
      "البند التاسع: البرامج والإعلانات والرعايات واستخدام الاستوديوهات والمعدات",
      "البند العاشر: ملكية القنوات والحسابات والمنصات الرقمية",
      "البند الحادي عشر: الملكية الفكرية وحقوق الاستغلال",
      "البند الثاني عشر: استخدام الاسم والصورة والصوت",
      "البند الثالث عشر: السرية وعدم إفشاء المعلومات",
      "البند الرابع عشر: عدم المنافسة وعدم استقطاب العملاء أو العاملين",
      "البند الخامس عشر: الجزاءات والإخلال بالالتزامات",
      "البند السادس عشر: الشرط الجزائي",
      "البند السابع عشر: حالات إنهاء العقد",
      "البند الثامن عشر: القوة القاهرة",
      "البند التاسع عشر: تسوية المنازعات والقانون الواجب التطبيق",
      "البند العشرون: أحكام عامة",
      "البند الحادي والعشرون: عدد النسخ",
    ],
