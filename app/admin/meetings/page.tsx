...
export default async function MeetingsPage({ searchParams }: { searchParams: Promise<{ status?: string; date?: string; error?: string; saved?: string; updated?: string }> }) {
  await requireAdmin();
